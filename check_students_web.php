...
<body>
    ...
    if ($count['count'] > 0) {
        ...
        echo "<h3>Students by Department and Batch:</h3>";
        $departments = ['CSE', 'ECE', 'MECH'];
        $batches = [2022, 2023, 2024, 2025];
        
        echo "<table>";
        echo "<tr><th>Department</th><th>Batch</th><th>Count</th><th>Action</th></tr>";
        foreach ($departments as $dept) {
            foreach ($batches as $batch) {
                ...
                echo "<td><a href='Admin/admin_front_page.php?dept=" . $dept . "&batch=" . $batch . "'>View in Admin Dashboard</a></td>";
                echo "</tr>";
                $stmt->close();
            }
        }
